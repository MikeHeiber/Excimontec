...
v1.0 has a particular focus on organic photovoltaic device modeling and can utilize complex bulk heterojunction morphologies generated using the ``Ising\_OPV`` tool.[@heiber2018joss]
...
This software package uses object-oriented design and extends the ``KMC\_Lattice`` framework.[@heiber2019joss] 
