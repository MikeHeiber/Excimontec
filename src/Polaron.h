...
namespace Excimontec {
	...
	class Polaron_Hop : public KMC_Lattice::Event {
	public:
		static const std::string event_type;
		Polaron_Hop() : KMC_Lattice::Event() {}
		Polaron_Hop(KMC_Lattice::Simulation* simulation_ptr) : KMC_Lattice::Event(simulation_ptr) {}
	...
	class Polaron_Recombination : public KMC_Lattice::Event {
	public:
		static const std::string event_type;
		Polaron_Recombination() : KMC_Lattice::Event() {}
		Polaron_Recombination(KMC_Lattice::Simulation* simulation_ptr) : KMC_Lattice::Event(simulation_ptr) {}
		void calculateRateConstant(const double prefactor, const double localization, const double distance, const double E_delta) {
	...
	class Polaron_Extraction : public KMC_Lattice::Event {
	public:
		static const std::string event_type;
		Polaron_Extraction() : KMC_Lattice::Event() {}
		Polaron_Extraction(KMC_Lattice::Simulation* simulation_ptr) : KMC_Lattice::Event(simulation_ptr) {}
		void calculateRateConstant(const double prefactor, const double localization, const double distance, const double E_delta) {
